...
namespace ThePrussianSoldier.TheChapters
{
    class Chapter_2
    {
        public Chapter_2()
        {
            ...
            string Two = "more pressing assignments, currently, you are behind the French lines, trying to make your way";
            string Three = "to a camp supplying the front with artillery and cannons.";

            AChoice: //Head towards the camp, Rest for a while, request reinforcements.
